...
type Property struct {
	...
	PhotoUploadDate     *time.Time `json:"photoUploadDate"`
	BlueprintBase64Data *string    `json:"blueprintBase64Data"`
	BlueprintFormat     *string    `json:"blueprintFormat"`
	BlueprintUploadDate *time.Time `json:"blueprintUploadDate"`
